...
function submit_score(){
	...
	$.post("http://localhost:5000/submit.json", {username: username, score: player.score}, function (data, textStatus) {
		try {
...
function load_high_scores() {
	$.getJSON("http://localhost:5000/scores.json", function(json) {
		scores = json;
