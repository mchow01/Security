...
function submit_score(){
	var username = $("#entry_box").val()
	$.post("http://192.168.1.4:5000/submit.json", {username: username, score: player.score}, function (data, textStatus) {
		try {
...
function load_high_scores() {
	$.getJSON("http://192.168.1.4:5000/scores.json", function(json) {
		scores = json;
