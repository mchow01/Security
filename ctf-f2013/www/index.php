...
<head>
	...
	<?php
		...
		if (empty($id)) {
        	   	echo '<div id="header"><h1><img id="logo" src="u7m2U8RPX0.png" /><br/>Not TorChan</h1></div>';
			...
			while ($row = mysql_fetch_array($myResult)) {
		     ...
		     echo '<div id="header"><h1 id="logo">Not TorChan</h1></div>';
	...
	<div id="footer">
		<hr/>
		<h3><a href="index.php">Home</a> | <a href="help/">Help</a> | <a href="admin.php">Administration</a></h3>
	</div>
	</body>
</head>
